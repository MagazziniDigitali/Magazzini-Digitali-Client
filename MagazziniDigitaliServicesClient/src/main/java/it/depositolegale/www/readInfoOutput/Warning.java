...
public class Warning  implements java.io.Serializable {
    ...
    /**
     * Gets the messaggio value for this Warning.
     * 
     * @return messaggio
     */
    ...
    /**
     * Sets the messaggio value for this Warning.
     * 
     * @param messaggio
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/readInfoOutput", "warning"));
