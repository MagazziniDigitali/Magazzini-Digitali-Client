/**
 * ConfirmDelMDPortSoapBindingStub.java
 *
...
public class ConfirmDelMDPortSoapBindingStub extends org.apache.axis.client.Stub implements it.depositolegale.www.webservice_confirmDelMD.ConfirmDelMDPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("ConfirmDelMDOperation");
    ...
    public ConfirmDelMDPortSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ConfirmDelMDPortSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ConfirmDelMDPortSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/readInfoInput", ">>readInfoInput>oggettoDigitale");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.readInfoInput.ReadInfoInputOggettoDigitale.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public void confirmDelMDOperation(it.depositolegale.www.readInfoInput.ReadInfoInput readInfoInput) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("", "ConfirmDelMDOperation"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {readInfoInput});
