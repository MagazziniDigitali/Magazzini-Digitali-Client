...
public class MdIstituzione  implements java.io.Serializable {
    private it.depositolegale.www.istituzione.MdIstituzioneAuthenticationUtenti authenticationUtenti;

    private it.depositolegale.www.errorMsg.ErrorMsg[] errorMsg;

    private it.depositolegale.www.istituzione.MdIstituzioneIstituzione istituzione;

    public MdIstituzione() {
    }

    public MdIstituzione(
           it.depositolegale.www.istituzione.MdIstituzioneAuthenticationUtenti authenticationUtenti,
           it.depositolegale.www.errorMsg.ErrorMsg[] errorMsg,
           it.depositolegale.www.istituzione.MdIstituzioneIstituzione istituzione) {
     ...
     */
    public it.depositolegale.www.istituzione.MdIstituzioneAuthenticationUtenti getAuthenticationUtenti() {
        return authenticationUtenti;
    }
     ...
     */
    public void setAuthenticationUtenti(it.depositolegale.www.istituzione.MdIstituzioneAuthenticationUtenti authenticationUtenti) {
        this.authenticationUtenti = authenticationUtenti;
    }
     ...
     * @return istituzione
     */
    public it.depositolegale.www.istituzione.MdIstituzioneIstituzione getIstituzione() {
        return istituzione;
    }
     ...
     * @param istituzione
     */
    public void setIstituzione(it.depositolegale.www.istituzione.MdIstituzioneIstituzione istituzione) {
        this.istituzione = istituzione;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.depositolegale.it/istituzione", "authenticationUtenti"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/istituzione", ">>mdIstituzione>authenticationUtenti"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/istituzione", ">>mdIstituzione>istituzione"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
