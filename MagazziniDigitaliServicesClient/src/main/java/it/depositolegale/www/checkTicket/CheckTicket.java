...
public class CheckTicket  implements java.io.Serializable {
    private it.depositolegale.www.checkTicket.CheckTicketSoftware software;
    ...
    public CheckTicket(
           it.depositolegale.www.checkTicket.CheckTicketSoftware software,
     ...
     * @return software
     */
    public it.depositolegale.www.checkTicket.CheckTicketSoftware getSoftware() {
        return software;
    }
     ...
     * @param software
     */
    public void setSoftware(it.depositolegale.www.checkTicket.CheckTicketSoftware software) {
        this.software = software;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.depositolegale.it/checkTicket", "software"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/checkTicket", ">>checkTicket>software"));
