/**
 * InitSendMDPortSoapBindingStub.java
 *
...
public class InitSendMDPortSoapBindingStub extends org.apache.axis.client.Stub implements it.depositolegale.www.webservice_initSendMD.InitSendMDPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("InitSendMDOperation");
    ...
    public InitSendMDPortSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public InitSendMDPortSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public InitSendMDPortSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public it.depositolegale.www.readInfoOutput.ReadInfoOutput initSendMDOperation(it.depositolegale.www.readInfoInput.ReadInfoInput readInfoInput) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("", "InitSendMDOperation"));
