/**
 * AuthenticationSoftwarePortSoapBindingStub.java
 *
...
public class AuthenticationSoftwarePortSoapBindingStub extends org.apache.axis.client.Stub implements it.depositolegale.www.webservice_authenticationSoftware.AuthenticationSoftwarePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("AuthenticationSoftwareOperation");
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.depositolegale.it/software", ">software"));
        oper.setReturnClass(it.depositolegale.www.software.Software.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://www.depositolegale.it/software", "software"));
    ...
    public AuthenticationSoftwarePortSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AuthenticationSoftwarePortSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AuthenticationSoftwarePortSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/software", ">>>software>istituzione>apiUtente");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.software.SoftwareIstituzioneApiUtente.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/software", ">>software>istituzione");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.software.SoftwareIstituzione.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/software", ">>software>rigth");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.software.SoftwareRigth.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public it.depositolegale.www.software.Software authenticationSoftwareOperation(it.depositolegale.www.login.Authentication authentication) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("", "AuthenticationSoftwareOperation"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {authentication});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (it.depositolegale.www.software.Software) _resp;
            } catch (java.lang.Exception _exception) {
                return (it.depositolegale.www.software.Software) org.apache.axis.utils.JavaUtils.convert(_resp, it.depositolegale.www.software.Software.class);
            }
        }
