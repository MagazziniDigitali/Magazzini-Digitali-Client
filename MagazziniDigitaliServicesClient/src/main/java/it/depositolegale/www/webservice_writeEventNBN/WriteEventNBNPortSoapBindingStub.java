...
public class WriteEventNBNPortSoapBindingStub extends org.apache.axis.client.Stub implements it.depositolegale.www.webservice_writeEventNBN.WriteEventNBNPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">writeEventNBN1"));
        oper.setReturnClass(it.depositolegale.www.writeEventNBN.WriteEventNBN1.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", "writeEventNBN1"));
    ...
    public WriteEventNBNPortSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">>>>writeEventNBN1>software>istituzione>apiUtente");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.writeEventNBN.WriteEventNBN1SoftwareIstituzioneApiUtente.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">>>writeEventNBN1>software>authentication");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.writeEventNBN.WriteEventNBN1SoftwareAuthentication.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">>>writeEventNBN1>software>istituzione");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.writeEventNBN.WriteEventNBN1SoftwareIstituzione.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">>>writeEventNBN1>software>rigth");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.writeEventNBN.WriteEventNBN1SoftwareRigth.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">>writeEventNBN1>esito");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.writeEventNBN.WriteEventNBN1Esito.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">>writeEventNBN1>software");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.writeEventNBN.WriteEventNBN1Software.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">writeEventNBN1");
            cachedSerQNames.add(qName);
            cls = it.depositolegale.www.writeEventNBN.WriteEventNBN1.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {writeEventNBN});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (it.depositolegale.www.writeEventNBN.WriteEventNBN1) _resp;
            } catch (java.lang.Exception _exception) {
                return (it.depositolegale.www.writeEventNBN.WriteEventNBN1) org.apache.axis.utils.JavaUtils.convert(_resp, it.depositolegale.www.writeEventNBN.WriteEventNBN1.class);
            }
        }
