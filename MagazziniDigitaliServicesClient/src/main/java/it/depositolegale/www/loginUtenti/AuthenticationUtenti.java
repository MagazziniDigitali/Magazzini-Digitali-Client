...
public class AuthenticationUtenti  implements java.io.Serializable {
    private it.depositolegale.www.loginUtenti.AuthenticationUtentiAuthentication authentication;

    private java.lang.String ipClient;

    private it.depositolegale.www.loginUtenti.AuthenticationUtentiSoftware software;

    public AuthenticationUtenti() {
    }

    public AuthenticationUtenti(
           it.depositolegale.www.loginUtenti.AuthenticationUtentiAuthentication authentication,
           java.lang.String ipClient,
           it.depositolegale.www.loginUtenti.AuthenticationUtentiSoftware software) {
     ...
     */
    public it.depositolegale.www.loginUtenti.AuthenticationUtentiAuthentication getAuthentication() {
        return authentication;
    }
     ...
     */
    public void setAuthentication(it.depositolegale.www.loginUtenti.AuthenticationUtentiAuthentication authentication) {
        this.authentication = authentication;
    }
     ...
     * @return software
     */
    public it.depositolegale.www.loginUtenti.AuthenticationUtentiSoftware getSoftware() {
        return software;
    }
     ...
     * @param software
     */
    public void setSoftware(it.depositolegale.www.loginUtenti.AuthenticationUtentiSoftware software) {
        this.software = software;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/loginUtenti", ">>authenticationUtenti>authentication"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.depositolegale.it/loginUtenti", "software"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/loginUtenti", ">>authenticationUtenti>software"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
