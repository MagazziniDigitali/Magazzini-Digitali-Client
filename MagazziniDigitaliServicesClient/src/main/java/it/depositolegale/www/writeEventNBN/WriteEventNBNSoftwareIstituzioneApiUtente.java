/**
 * WriteEventNBNSoftwareIstituzioneApiUtente.java
 *
...
public class WriteEventNBNSoftwareIstituzioneApiUtente  implements java.io.Serializable {
    private org.apache.axis.types.URI interfaccia;

    private java.lang.String libreria;

    public WriteEventNBNSoftwareIstituzioneApiUtente() {
    }
    ...
    /**
     * Gets the interfaccia value for this WriteEventNBNSoftwareIstituzioneApiUtente.
     * 
     * @return interfaccia
     */
    ...
    /**
     * Sets the interfaccia value for this WriteEventNBNSoftwareIstituzioneApiUtente.
     * 
     * @param interfaccia
     */
    ...
    /**
     * Gets the libreria value for this WriteEventNBNSoftwareIstituzioneApiUtente.
     * 
     * @return libreria
     */
    ...
    /**
     * Sets the libreria value for this WriteEventNBNSoftwareIstituzioneApiUtente.
     * 
     * @param libreria
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WriteEventNBNSoftwareIstituzioneApiUtente)) return false;
        WriteEventNBNSoftwareIstituzioneApiUtente other = (WriteEventNBNSoftwareIstituzioneApiUtente) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WriteEventNBNSoftwareIstituzioneApiUtente.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/writeEventNBN", ">>>>writeEventNBN>software>istituzione>apiUtente"));
