...
public class CheckTicketOutput  implements java.io.Serializable {
    private it.depositolegale.www.checkTicketOutput.CheckTicketOutputCheckTicket checkTicket;
    ...
    public CheckTicketOutput(
           it.depositolegale.www.checkTicketOutput.CheckTicketOutputCheckTicket checkTicket,
     ...
     * @return checkTicket
     */
    public it.depositolegale.www.checkTicketOutput.CheckTicketOutputCheckTicket getCheckTicket() {
        return checkTicket;
    }
     ...
     * @param checkTicket
     */
    public void setCheckTicket(it.depositolegale.www.checkTicketOutput.CheckTicketOutputCheckTicket checkTicket) {
        this.checkTicket = checkTicket;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.depositolegale.it/checkTicketOutput", "checkTicket"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/checkTicketOutput", ">>checkTicketOutput>checkTicket"));
