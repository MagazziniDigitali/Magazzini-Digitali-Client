...
public class EndSend  implements java.io.Serializable {
    private it.depositolegale.www.endSend.EndSendReadInfoOutput readInfoOutput;
    ...
    public EndSend(
           it.depositolegale.www.endSend.EndSendReadInfoOutput readInfoOutput,
           boolean esito,
     ...
     */
    public it.depositolegale.www.endSend.EndSendReadInfoOutput getReadInfoOutput() {
        return readInfoOutput;
    }
     ...
     */
    public void setReadInfoOutput(it.depositolegale.www.endSend.EndSendReadInfoOutput readInfoOutput) {
        this.readInfoOutput = readInfoOutput;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.depositolegale.it/endSend", "readInfoOutput"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/endSend", ">>endSend>readInfoOutput"));
