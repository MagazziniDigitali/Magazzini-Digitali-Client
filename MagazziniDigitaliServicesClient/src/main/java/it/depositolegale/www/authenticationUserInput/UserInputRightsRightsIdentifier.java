/**
 * UserInputRightsRightsIdentifier.java
 *
...
public class UserInputRightsRightsIdentifier  implements java.io.Serializable {
    private java.lang.String rightsIdentifierType;

    private java.lang.String rightsIdentifierValue;

    public UserInputRightsRightsIdentifier() {
    }
    ...
    /**
     * Gets the rightsIdentifierType value for this UserInputRightsRightsIdentifier.
     * 
    ...
    /**
     * Sets the rightsIdentifierType value for this UserInputRightsRightsIdentifier.
     * 
    ...
    /**
     * Gets the rightsIdentifierValue value for this UserInputRightsRightsIdentifier.
     * 
    ...
    /**
     * Sets the rightsIdentifierValue value for this UserInputRightsRightsIdentifier.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UserInputRightsRightsIdentifier)) return false;
        UserInputRightsRightsIdentifier other = (UserInputRightsRightsIdentifier) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UserInputRightsRightsIdentifier.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.depositolegale.it/authenticationUserInput", ">>userInput>rights>rightsIdentifier"));
